...
type
  TViewPrincipal = class(TForm)
    ...
    SpeedButtonReceber: TSpeedButton;
    ...
    procedure SpeedButtonReceberClick(Sender: TObject);
  private
...
procedure TViewPrincipal.SpeedButtonReceberClick(Sender: TObject);
begin
    GET_LineMenu (Sender);
    ...
    try
      //centralizar form
      ViewReceber.Top := Round(panelTopo.Height + 29 + ((panelConteudo.Height - ViewReceber.Height)/2));
      ViewReceber.Left := Round(panelDadosMenu.Width + ((panelConteudo.Width - ViewReceber.Width)/2));
